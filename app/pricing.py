...
index ebc1e003fb6266bd1ef5f98480049abe7f6d36b0..ea1b052a5611d993529556e6ec1a99b9159ee4ea 100644
--- a/app/pricing.py
+++ b/app/pricing.py
@@ -1,67 +1,161 @@
 import asyncio
...
+    """Proxy for institutional interest: large XRP prints on Binance."""
...
-            continue
-        quotes.append(r)
+        # Prefer TwelveData for all four markets, with existing fallbacks.
+        td_tasks = [fetch_twelvedata_last(client, sym) for sym in [SYMBOL_XRP, SYMBOL_GOLD, SYMBOL_SILVER, SYMBOL_OIL]]
...
-    return quotes
+    return [quotes_by_symbol[s] for s in [SYMBOL_XRP, SYMBOL_GOLD, SYMBOL_SILVER, SYMBOL_OIL] if s in quotes_by_symbol]
